...
public class GraduateService implements UserService {
    ...
    public UserResponseDTO createUser(UserRequestDTO request) {
        ...
        log.info("Graduado creado con ID: {} y correo: {}", savedUser.getId(), savedUser.getEmail());
    ...
    public UserResponseDTO updateUser(Long id, UserRequestDTO dto) {
        ...
        log.info("Graduado actualizado con ID: {} correo antiguo: {}y correo: {}", updated.getId(),dto.getEmail(), updated.getEmail());
