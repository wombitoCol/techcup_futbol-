...
public class GoalDifferenceTieBreaker implements TieBreakingStrategy {
    @Override
    public List<TournamentTeam> calculatePositions(List<TournamentTeam> teams) {
        ...
        sortedTeams.sort((team1, team2) -> Integer.compare(team2.getGoalDifference(), team1.getGoalDifference()));
